    ...
    <section id="services" className="py-20 border-t border-black/5 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {services.map((s) => (
            <div key={s.title} className="group rounded-xl border border-gray-200 bg-white p-5 hover:shadow-lg transition-all">
        ...
        <div id="approach" className="mt-16 grid gap-6 md:grid-cols-3">
          <div className="rounded-2xl p-6 border border-gray-200 bg-gradient-to-br from-gray-50 to-white">
            <h4 className="font-semibold">Design → Build → Launch</h4>
            <p className="mt-2 text-sm text-gray-600">End-to-end ownership across product design, engineering, and deployment. One team, accountable outcomes.</p>
          </div>
          <div className="rounded-2xl p-6 border border-gray-200 bg-gradient-to-br from-gray-50 to-white">
            <h4 className="font-semibold">Speed with substance</h4>
            <p className="mt-2 text-sm text-gray-600">Lean sprints, rapid validation, and a strong foundation—so v1 ships fast and v2 scales even faster.</p>
          </div>
          <div className="rounded-2xl p-6 border border-gray-200 bg-gradient-to-br from-gray-50 to-white">
            <h4 className="font-semibold">AI where it matters</h4>
            <p className="mt-2 text-sm text-gray-600">Pragmatic AI that drives measurable impact—automation, copilots, personalization, and smarter decisions.</p>
          </div>
        </div>
      </div>
    </section>
